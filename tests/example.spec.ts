...
test('should navigate to the Login page page', async ({ page }) => {
  // Start from the index page (the baseURL is set via the webServer in the playwright.config.ts)
  await page.goto('https://musicmaster01.kinde.com/auth/cx/_:nav&m:register&psid:5e2df1128935417db456a28829e85ec7')
  // Find an element with the text 'About' and click on it
  await page.click('text=Sign in')
  // The new URL should be "/about" (baseURL is used there)
  await expect(page).toHaveURL('https://musicmaster01.kinde.com/auth/cx/_:nav&m:login&psid:5e2df1128935417db456a28829e85ec7')
